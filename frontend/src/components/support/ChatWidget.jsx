              ...
              <div className="space-y-4">
                ...
                {isTyping && (
                  <div className="flex justify-start">
                    <div className="bg-gray-50 text-gray-800 p-3 rounded-xl border border-gray-200">
                ...
                <div className="flex flex-wrap gap-1">
                  {suggestedQuestions.slice(0, 4).map((question, index) => (
                    <button
                      ...
                      className="text-xs bg-white hover:bg-primary/10 text-gray-700 px-3 py-1.5 rounded-full transition-all duration-200 border border-gray-200 hover:border-primary/30 hover:text-primary shadow-sm"
                    >
                      {question}
                    </button>
                  ))}
              ...
              <div className="flex items-center space-x-2">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    className="w-full p-3 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 bg-white transition-all duration-200"
                    rows="1"
