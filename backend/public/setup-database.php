...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO knowledgebase (title, slug, content, excerpt, category_id, tags) VALUES (:title, :slug, :content, :excerpt, :category_id, :tags) ON CONFLICT (slug) DO NOTHING");
    ...
    echo json_encode([
        ...
        'tables_created' => ['contact_submissions', 'knowledgebase_categories', 'knowledgebase', 'support_tickets'],
        'sample_data' => 'Default categories and sample articles have been created'
    ]);
