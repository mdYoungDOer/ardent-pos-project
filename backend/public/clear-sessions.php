...
if ($providedKey !== $secretKey) {
    ...
    echo json_encode([
        'success' => false,
        'error' => 'Invalid secret key. Please provide the correct key parameter.',
        'usage' => 'Use: ?key=ardent-pos-session-clear-2024'
    ]);
    exit;
}
...
try {
    ...
    try {
        ...
        $stmt->execute([
            ...
            'Global session and cache clearing initiated via web script',
