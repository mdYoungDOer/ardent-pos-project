        ...
        case 'GET':
            switch ($action) {
                case 'test':
                    echo json_encode([
                        'success' => true,
                        'message' => 'Notifications API is working perfectly!',
                ...
                default:
                    echo json_encode([
                        ...
                        'available_actions' => ['test', 'test-email', 'settings', 'logs'],
                        'usage' => 'Add ?action=test or ?action=test-email&email=your@email.com'
                    ]);
                    break;
            }
            break;
