...
try {
    ...
    $articles = [
        [
            ...
            'meta_description' => 'Complete guide to setting up your Ardent POS account and making your first sale',
        ...
        [
            ...
            'meta_description' => 'Learn how to navigate and customize your Ardent POS dashboard for optimal business insights',
        ...
        [
            ...
            'meta_description' => 'Complete guide to processing sales transactions in Ardent POS with step-by-step instructions',
        ...
        [
            ...
            'meta_description' => 'Complete guide to adding and managing products in your Ardent POS inventory system',
        ...
        [
            ...
            'meta_description' => 'Learn how to manage your customer database, add new customers, and segment your customer base',
        ...
        [
            ...
            'meta_description' => 'Learn how to interpret sales reports and use analytics to improve your business performance',
        ...
        [
            ...
            'meta_description' => 'Complete guide to setting up and configuring POS hardware including printers, scanners, and payment terminals',
        ...
        [
            ...
            'meta_description' => 'Integrate payment gateways to accept various payment methods securely',
        ...
        [
            ...
            'meta_description' => 'Set up user roles and permissions to control access to different parts of your POS system',
        ...
        [
            ...
            'meta_description' => 'Quick solutions for common POS system issues and problems',
    ...
    $stmt = $pdo->prepare("
        INSERT INTO knowledgebase (
            category_id, title, content, slug, meta_description, tags, 
            is_published, author_id, helpful_count, not_helpful_count, view_count, created_at, updated_at
        ) VALUES (
            :category_id, :title, :content, :slug, :meta_description, :tags,
            :is_published, :author_id, :helpful_count, :not_helpful_count, :view_count, NOW(), NOW()
        )
    ");
